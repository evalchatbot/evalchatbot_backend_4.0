...
class DocumentProcessor:
    ...
    def prepare_chunks_for_db(self, chunks: List[Dict], book_id: str, genre: str) -> List[Dict]:
        """
        Prepare chunks for DB upload: map 'content' to 'text', add book_id, genre, created_at, and unique id.
        """
        ...
        for chunk in chunks:
            ready.append({
                ...
                "genre": genre,
                "created_at": now,
                # Optionally add page_start, page_end, metadata if you want to extend your schema
            })
        return ready
